...
class Harmful(pygame.sprite.Sprite):
    ...
    def __init__(self, enemies):
        ...
        enemy_list = Sprites("images/evil.png")
...
class Platform(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_sheet_data):
        ...
        sprite_sheet = Sprites("images/organic_tiles.png")
    ...
    def update(self):
        ...
        if cur_pos_y > self.boundary_bottom:
            ...
            if not self.player.lost:
                if self.change_y == 4:
                    self.player.set_score(1)    # if enemy is pumkin get +1 score
        ...
        if cur_pos < self.boundary_left:
            ...
            if not self.player.lost:
                if self.change_x == -4:
                    self.player.set_score(2)    #if enemy is bat get +2 score
                elif self.change_x == -8:
                    self.player.set_score(4)    #if enemy is witch get +4 score

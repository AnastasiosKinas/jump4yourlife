...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        sprites = Sprites("images/jump_001.png")
        ...
        sprites = Sprites("images/walk_000.png")
        ...
        sprites = Sprites("images/walk_001.png")
        image = sprites.get_image(0, 0, 105, 95)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.walking_frames_r.append(image)
        ...
        sprites = Sprites("images/walk_002.png")
        image = sprites.get_image(0, 0, 105, 95)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.walking_frames_r.append(image)
        ...
        sprites = Sprites("images/walk_003.png")
        image = sprites.get_image(0, 0, 105, 95)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.walking_frames_r.append(image)
        ...
        sprites = Sprites("images/walk_004.png")
        image = sprites.get_image(0, 0, 105, 95)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.walking_frames_r.append(image)
        ...
        #Death Sprite
        sprites = Sprites("images/die_004.png")
        image = sprites.get_image(0, 0, 95, 91)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.death_frame = image

        sprites = Sprites("images/idle_000.png")
        image = sprites.get_image(0, 0, 95, 91)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        ...
        sprites = Sprites("images/flash.png")
        image = sprites.get_image(0, 0, 95, 91)
        color_switch = image.get_at((0, 0))
        image.set_colorkey(color_switch)
        self.flash_frame = image

        sprites = Sprites("images/hurt1.png")
